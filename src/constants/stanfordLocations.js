...
// Format: "Current Location: buildingName, address"
DEFAULT_PICKUP_LOCATION.displayText = `${DEFAULT_PICKUP_LOCATION.displayName} ${DEFAULT_PICKUP_LOCATION.buildingName}, ${DEFAULT_PICKUP_LOCATION.address}`;
